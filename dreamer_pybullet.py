...
if __name__ == '__main__':
    for name in ["AntBulletEnv-v0", "HopperBulletEnv-v0", "HumanoidBulletEnv-v0", "ReacherBulletEnv-v0", "Walker2DBulletEnv-v0"]:
        config = define_config()
        config.logdir = config.logdir.joinpath(name)
        config.task = "bullet_"+name
        main(config)